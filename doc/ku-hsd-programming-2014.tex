...
\lstinputlisting[language=Python]{../examples/01/say-hello.py2}
...
\lstinputlisting[language=Python]{../examples/01/say-hello.py3}
...
\lstinputlisting[language=Python]{../examples/02/fractions.py2}
\newpage

A solution for the problem in Python 3:
\lstinputlisting[language=Python]{../examples/02/fractions.py3}
\newpage
